        ...
        <section id="contact" className={styles.contact}>
            <div className={`container ${styles.container}`}>
                <div className={styles.info}>
                    ...
                    <p className={styles.description} style={{ maxWidth: '560px', textAlign: 'center' }}>
                    ...
                    <div className={styles.contactCard}>
                        <div className={styles.contactDetails}>
                            <div className={styles.detailItem}>
                                ...
                                <span className={styles.detailLabel}>{t.contact.emailLabel}</span>
                                <a href="mailto:sondiedh@gmail.com" className={styles.detailLink}>sondiedh@gmail.com</a>
                            </div>
                            <div className={styles.detailItem}>
                                <span className={styles.detailIcon}>📍</span>
                                <span className={styles.detailLabel}>{t.contact.locationLabel}</span>
                    ...
                    <div className={styles.socials}>
                        <a href="https://github.com/sondiedh-sys" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                        ...
                        <a href="https://tryhackme.com/p/doudouu" target="_blank" rel="noopener noreferrer" className={styles.badgeLink} aria-label="TryHackMe Profile">
                            <iframe
                                src="https://tryhackme.com/api/v2/badges/public-profile?userPublicId=3689123"
                                style={{ border: 'none', pointerEvents: 'none', width: '300px', height: '90px', borderRadius: '10px', display: 'block' }}
